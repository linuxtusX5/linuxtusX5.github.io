...
export default class BSIT1 extends React.Component {
  constructor(props) {
    super(props);
  ...
  viewClick(name) {
    ...
    fetch(variables.API_URL + "ibits/" + name, {
      method: "GET",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
  ...
  render() {
    const { ibits, Title, studentId, studentName, Gmail, DateOfJoining } =
      this.state;
