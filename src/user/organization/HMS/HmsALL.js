...
function HmsALL() {
  ...
  const updateData = async (e) => {
    ...
    db.collection("BSHM1").doc(dataID).update({
    ...
    db.collection("BSHM2").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSHM3").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSHM4").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("HMS").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
  ...
  const deleteData = (id) => {
    db.collection("BSHM1").doc(id).delete();
    db.collection("BSHM2").doc(id).delete();
    db.collection("BSHM3").doc(id).delete();
    db.collection("BSHM4").doc(id).delete();
    db.collection("HMS").doc(id).delete();
    handleClose3();
  };
    ...
    <>
      ...
      <div className="App">
        ...
        >
          ...
          >
            <strong style={{ marginTop: "20px" }}>HMS STUDENT RECORD</strong>
          </h1>
        </Card>
