...
const UpdatedDateString = updatedDate2.toString();
 ...
 const updateData = async (e) => {
   ...
   db.collection("BEED1").doc(dataID).update({
   ...
   db.collection("BEED2").doc(dataID).update({
     firstName: updatedFirstName,
     lastName: updatedLastName,
     Birth: UpdatedDateString,
     organization: updatedOrg,
   ...
   db.collection("BEED3").doc(dataID).update({
     firstName: updatedFirstName,
     lastName: updatedLastName,
     Birth: UpdatedDateString,
     organization: updatedOrg,
   ...
   db.collection("BEED4").doc(dataID).update({
     firstName: updatedFirstName,
     lastName: updatedLastName,
     Birth: UpdatedDateString,
     organization: updatedOrg,
     ...
     db.collection("BSED1").doc(dataID).update({
       firstName: updatedFirstName,
       lastName: updatedLastName,
       Birth: UpdatedDateString,
       organization: updatedOrg,
     ...
     db.collection("BSED2").doc(dataID).update({
       firstName: updatedFirstName,
       lastName: updatedLastName,
       Birth: UpdatedDateString,
       organization: updatedOrg,
     ...
     db.collection("BSED3").doc(dataID).update({
       firstName: updatedFirstName,
       lastName: updatedLastName,
       Birth: UpdatedDateString,
       organization: updatedOrg,
     ...
     db.collection("BSED4").doc(dataID).update({
       firstName: updatedFirstName,
       lastName: updatedLastName,
       Birth: UpdatedDateString,
       organization: updatedOrg,
   ...
   db.collection("YES").doc(dataID).update({
     firstName: updatedFirstName,
     lastName: updatedLastName,
     Birth: UpdatedDateString,
     organization: updatedOrg,
 ...
 const deleteData = (id) => {
   db.collection("BEED1").doc(id).delete();
   db.collection("BEED2").doc(id).delete();
   db.collection("BEED3").doc(id).delete();
   db.collection("BEED4").doc(id).delete();
   db.collection("BSED1").doc(id).delete();
   db.collection("BSED2").doc(id).delete();
   db.collection("BSED3").doc(id).delete();
   db.collection("BSED4").doc(id).delete();
   db.collection("YES").doc(id).delete();
   handleClose3();
 };
    ...
    <>
      ...
      <div className="App">
        ...
        >
          ...
          >
            <strong style={{ marginTop: "20px" }}>YES STUDENT RECORD</strong>
          </h1>
        </Card>
