...
const UpdatedDateString = updatedDate2.toString();
  ...
  const updateData = async (e) => {
    ...
    db.collection("BSCE1").doc(dataID).update({
    ...
    db.collection("BSCE2").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSCE3").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSCE4").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("PICE").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
  ...
  const deleteData = (id) => {
    db.collection("BSSE1").doc(id).delete();
    db.collection("BSSE2").doc(id).delete();
    db.collection("BSSE3").doc(id).delete();
    db.collection("BSSE4").doc(id).delete();
    db.collection("DCET1").doc(id).delete();
    db.collection("DCET2").doc(id).delete();
    db.collection("DCET3").doc(id).delete();
    db.collection("PICE").doc(id).delete();
    handleClose3();
  };
    ...
    <>
      ...
      <div className="App">
        ...
        >
          ...
          >
            <strong style={{ marginTop: "20px" }}>PICE STUDENT RECORD</strong>
          </h1>
        </Card>
