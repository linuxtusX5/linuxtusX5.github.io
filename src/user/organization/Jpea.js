...
function Jpea() {
  ...
  useEffect(() => {
    db.collection("JPEA").onSnapshot((snapshot) => {
      setStudent(
  ...
  const updateData = async (e) => {
    ...
    db.collection("JPEA").doc(dataIdToBeUpdated).update({
  ...
  const deleteData = (id) => {
    db.collection("JPEA").doc(id).delete();
  };
    ...
    <>
      ...
      <div className="App">
        ...
        >
          ...
          <h1 className="pup">
            <strong>JPEA STUDENT RECORD</strong>
          </h1>
        </Card>
        <Button
          variant="primary"
        ...
        <h4 style={{ color: "#4c0001" }}>
          <strong>NUMBERS OF STUDENT [ {Student.length} ]</strong>
        </h4>
