...
const UpdatedDateString = updatedDate2.toString();
  ...
  const updateData = async (e) => {
    ...
    db.collection("DOMT-LOM1").doc(dataID).update({
    ...
    db.collection("DOMT-LOM2").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("DOMT-LOM3").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("DOMT-MOM1").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("DOMT-MOM2").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("DOMT-MOM3").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("SYNERTECH").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
  ...
  const deleteData = (id) => {
    db.collection("DOMT-LOM1").doc(id).delete();
    db.collection("DOMT-LOM2").doc(id).delete();
    db.collection("DOMT-LOM3").doc(id).delete();
    db.collection("DOMT-MOM1").doc(id).delete();
    db.collection("DOMT-MOM2").doc(id).delete();
    db.collection("DOMT-MOM3").doc(id).delete();
    db.collection("SYNERTECH").doc(id).delete();
    handleClose3();
  };
