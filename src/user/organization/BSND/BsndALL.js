...
function BsndALL() {
  ...
  const updateData = async (e) => {
    ...
    db.collection("BSND1").doc(dataID).update({
    ...
    db.collection("BSND2").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSND3").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSND4").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSND").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
  ...
  const deleteData = (id) => {
    db.collection("BSND1").doc(id).delete();
    db.collection("BSND2").doc(id).delete();
    db.collection("BSND3").doc(id).delete();
    db.collection("BSND4").doc(id).delete();
    db.collection("BSND").doc(id).delete();
    handleClose3();
  };
    ...
    <>
      ...
      <div className="App">
        ...
        >
          ...
          >
            <strong style={{ marginTop: "20px" }}>BSND STUDENT RECORD</strong>
          </h1>
        </Card>
