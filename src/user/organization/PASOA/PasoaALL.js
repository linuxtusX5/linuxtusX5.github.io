...
const UpdatedDateString = updatedDate2.toString();
  ...
  const updateData = async (e) => {
    ...
    db.collection("BSOA1").doc(dataID).update({
    ...
    db.collection("BSOA2").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSOA3").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSOA4").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("PASOA").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
  ...
  const deleteData = (id) => {
    db.collection("BSOA1").doc(id).delete();
    db.collection("BSOA2").doc(id).delete();
    db.collection("BSOA3").doc(id).delete();
    db.collection("BSOA4").doc(id).delete();
    db.collection("PASOA").doc(id).delete();
    handleClose3();
  };
    ...
    <>
      ...
      <div className="App">
        ...
        >
          ...
          >
            <strong style={{ marginTop: "20px" }}>PASOA STUDENT RECORD</strong>
          </h1>
        </Card>
