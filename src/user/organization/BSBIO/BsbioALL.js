...
function BsbioALL() {
  ...
  const updateData = async (e) => {
    ...
    db.collection("BSBIO1").doc(dataID).update({
    ...
    db.collection("BSBIO2").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSBIO3").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSBIO4").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSBIOALL").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
  ...
  const deleteData = (id) => {
    db.collection("BSBIO1").doc(id).delete();
    db.collection("BSBIO2").doc(id).delete();
    db.collection("BSBIO3").doc(id).delete();
    db.collection("BSBIO4").doc(id).delete();
    db.collection("BSBIO").doc(id).delete();
    handleClose3();
  };
    ...
    <>
      ...
      <div className="App">
        ...
        >
          ...
          >
            <strong style={{ marginTop: "20px" }}>BSBIO STUDENT RECORD</strong>
          </h1>
        </Card>
