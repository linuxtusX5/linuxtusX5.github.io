...
function JmeALL() {
  ...
  const updateData = async (e) => {
    ...
    db.collection("BSBA1").doc(dataID).update({
    ...
    db.collection("BSBA2").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSBA3").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSBA4").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("JME").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
  ...
  const deleteData = (id) => {
    db.collection("BSBA1").doc(id).delete();
    db.collection("BSBA2").doc(id).delete();
    db.collection("BSBA3").doc(id).delete();
    db.collection("BSBA4").doc(id).delete();
    db.collection("JME").doc(id).delete();
    handleClose3();
  };
    ...
    <>
      ...
      <div className="App">
        ...
        >
          ...
          >
            <strong style={{ marginTop: "20px" }}>JME STUDENT RECORD</strong>
          </h1>
        </Card>
