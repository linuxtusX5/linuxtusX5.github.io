...
function JpiaALL() {
  ...
  const updateData = async (e) => {
    ...
    db.collection("BSA1").doc(dataID).update({
    ...
    db.collection("BSA2").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSA3").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSA4").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("JPIA").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
  ...
  const deleteData = (id) => {
    db.collection("BSA1").doc(id).delete();
    db.collection("BSA2").doc(id).delete();
    db.collection("BSA3").doc(id).delete();
    db.collection("BSA4").doc(id).delete();
    db.collection("JPIA").doc(id).delete();
    handleClose3();
  };
    ...
    <>
      ...
      <div className="App">
        ...
        >
          ...
          >
            <strong style={{ marginTop: "20px" }}>JPIA STUDENT RECORD</strong>
          </h1>
        </Card>
