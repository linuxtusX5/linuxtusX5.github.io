...
function PadsALL() {
  ...
  const updateData = async (e) => {
    ...
    db.collection("BPA1").doc(dataID).update({
    ...
    db.collection("BPA2").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BPA3").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BPA4").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("PAdS").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
  ...
  const deleteData = (id) => {
    db.collection("BPA1").doc(id).delete();
    db.collection("BPA2").doc(id).delete();
    db.collection("BPA3").doc(id).delete();
    db.collection("BPA4").doc(id).delete();
    db.collection("PAdS").doc(id).delete();
    handleClose3();
  };
