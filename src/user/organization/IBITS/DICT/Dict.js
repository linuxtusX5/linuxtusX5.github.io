...
const UpdateDateString = updatedDate.toString();

  useEffect(() => {
    db.collection("DICT1").onSnapshot((snapshot) => {
      setStudent(
 ...
 const handleValidation = (evnt) => {
  ...
  const updateData = async (e) => {
    ...
    db.collection("DICT1").doc(dataIdToBeUpdated).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdateDateString,
    ...
    <>
      ...
      <div className="App">
        ...
        >
          ...
          >
            <strong style={{ marginTop: "20px" }}>DICT 1 STUDENT RECORD</strong>
          </h1>
        </Card>
        <Button
          variant="primary"
