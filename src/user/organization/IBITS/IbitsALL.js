...
function IbitsALL() {
  ...
  const updateData = async (e) => {
    ...
    db.collection("BSIT1").doc(dataID).update({
    ...
    db.collection("BSIT2").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSIT3").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSIT4").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("DICT1").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("DICT2").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("DICT3").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("DCET1").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("DCET2").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("DCET3").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("IBITS").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
  ...
  const deleteData = (id) => {
    db.collection("BSIT1").doc(id).delete();
    db.collection("BSIT2").doc(id).delete();
    db.collection("BSIT3").doc(id).delete();
    db.collection("BSIT4").doc(id).delete();
    db.collection("DICT1").doc(id).delete();
    db.collection("DICT2").doc(id).delete();
    db.collection("DICT3").doc(id).delete();
    db.collection("DCET1").doc(id).delete();
    db.collection("DCET2").doc(id).delete();
    db.collection("DCET3").doc(id).delete();
    db.collection("IBITS").doc(id).delete();
    handleClose3();
  };
    ...
    <>
      ...
      <div className="App">
        ...
        >
          ...
          >
            <strong style={{ marginTop: "20px" }}>IBITS STUDENT RECORD</strong>
          </h1>
        </Card>
