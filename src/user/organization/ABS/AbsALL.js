...
function AbsALL() {
  ...
  const updateData = async (e) => {
    ...
    db.collection("BSAME1").doc(dataID).update({
    ...
    db.collection("BSAME2").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSAME3").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("BSAME4").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
    ...
    db.collection("ABS").doc(dataID).update({
      firstName: updatedFirstName,
      lastName: updatedLastName,
      Birth: UpdatedDateString,
      organization: updatedOrg,
  ...
  const deleteData = (id) => {
    db.collection("BSAME1").doc(id).delete();
    db.collection("BSAME2").doc(id).delete();
    db.collection("BSAME3").doc(id).delete();
    db.collection("BSAME4").doc(id).delete();
    db.collection("ABS").doc(id).delete();
    handleClose3();
  };
    ...
    <>
      ...
      <div className="App">
        ...
        >
          ...
          >
            <strong style={{ marginTop: "20px" }}>ABS STUDENT RECORD</strong>
          </h1>
        </Card>
