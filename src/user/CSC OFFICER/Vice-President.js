...
const President = () => {
  ...
  const updateData = async (e) => {
    ...
    await db.collection("Vice-President").doc(dataIdToBeUpdated).update({
      name: updatedInput,
  ...
  const onSubmit = async (e) => {
    ...
    await db.collection("Vice-President").doc(username).set({
      name: username,
      EventPic: fileUrl,
      Description: desc,
      timestamp: new Date(),
  ...
  const deletedocs = (dataIdToBeUpdated) => {
    db.collection("Vice-President").doc(dataIdToBeUpdated).delete();
    Swal.fire({
      position: "center",
      icon: "success",
      title: "Success",
        ...
        <DialogActions>
          ...
          <DrawerHeader />
            ...
            <div className="container header2">
              <h1>
                <span className="design2">VICE-PRESIDENT</span>
              </h1>
            </div>
                {users.map((user, name) => {
                  return (
