...
const Councilor7 = () => {
  ...
  const updateData = async (e) => {
    ...
    await db.collection("Councilor7").doc(dataIdToBeUpdated).update({
      name: updatedInput,
  ...
  const onSubmit = async (e) => {
    ...
    await db.collection("Councilor7").doc(username).set({
      name: username,
      EventPic: fileUrl,
      Description: desc,
      timestamp: new Date(),
  ...
  const deletedocs = (dataIdToBeUpdated) => {
    db.collection("Councilor7").doc(dataIdToBeUpdated).delete();
    Swal.fire({
      position: "center",
      icon: "success",
      title: "Success",
        ...
        <DialogActions>
          ...
          <DrawerHeader />
            ...
            <div className="container header2">
              <h1>
                <span className="design2">COUNCILOR</span>
              </h1>
            </div>
