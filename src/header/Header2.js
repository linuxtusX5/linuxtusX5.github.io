...
import LogUser from "./login/LoginUser";
import NoticeAdmin from "./login/Announce_admin";
          ...
          <div className="w-full ">
            {lists.map((list) => (
              ...
              >
                ...
                <b style={{ marginLeft: "25px" }}>{list.name}</b>
              </div>
            ))}
          </div>
        </Modal.Body>
          ...
          >
            <Container>
              ...
              <Navbar.Collapse className="justify-content-end">
                <Nav>
                  <Nav.Link eventKey="Navs" as={Link} to={"/Navs"}>
                    <i className="fas fa-home"> Home</i>
                  </Nav.Link>
                  <Nav.Link eventKey="User" as={Link} to={"/User"}>
                    <i className="fas fa-calendar-week"> Event</i>
                  </Nav.Link>
                  <Dropdown>
                  ...
                  <Dropdown>
                    ...
                    <Dropdown.Menu>
                      <Dropdown.Item as={Link} to={"/LogUser"}>
                        <b>Event</b>
                      </Dropdown.Item>
                      <Dropdown.Item as={Link} to={"/NoticeAdmin"}>
                        <b>Announcement</b>
                      </Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
