...
export default class DICT3 extends React.Component {
  ...
  deleteClick(id) {
    if (window.confirm("Are you sure?")) {
      fetch(variables.API_URL + "dict3/" + id, {
        method: "DELETE",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  render() {
    const { dict3, Title, studentId, studentName, Gmail, DateOfJoining } =
      this.state;
    ...
    return (
      <div id="wtf">
        ...
        >
          Diploma Information Communication Technology (DICT-3)
        </h2>
        <button
          type="button"
          className="btn btn-primary m-2 float-end"
          data-bs-toggle="modal"
          data-bs-target="#sampleModal13"
