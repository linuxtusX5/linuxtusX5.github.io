...
export default class DCET1 extends React.Component {
  constructor(props) {
    super(props);
  ...
  deleteClick(id) {
    if (window.confirm("Are you sure?")) {
      fetch(variables.API_URL + "dcet1/" + id, {
        method: "DELETE",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  viewClick(name) {
    ...
    fetch(variables.API_URL + "dcet1/" + name, {
      method: "GET",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
      ...
      .then((data) => {
        this.setState({ dcet1: data });
        console.log({ dcet1: data });
      });
  }

  render() {
    const { dcet1, Title, studentId, studentName, Gmail, DateOfJoining } =
      this.state;
    ...
    return (
      <div id="wtf">
        ...
        >
          Diploma Computer Engineering Technology (DCET-1)
        </h2>
        <button
          type="button"
          className="btn btn-primary m-2 float-end"
          data-bs-toggle="modal"
          data-bs-target="#sampleModal15"
